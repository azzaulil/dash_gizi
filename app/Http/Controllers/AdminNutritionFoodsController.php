<?php namespace App\Http\Controllers;
	...
	class AdminNutritionFoodsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "gizi_nutrition_foods";
			...
			$this->col[] = ["label"=>"Nilai nutrisi","name"=>"value"];
