<?php namespace App\Http\Controllers;
	...
	class AdminUserReportsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Date Report","name"=>"date_report"];
			$this->col[] = ["label"=>"Pre Image","name"=>"pre_image","image"=>true];
			$this->col[] = ["label"=>"Post Image","name"=>"post_image","image"=>true];
			$this->col[] = ["label"=>"Percentage","name"=>"percentage"];
			$this->col[] = ["label"=>"Status Report","name"=>"status_report"];
			...
			$this->form[] = ['label'=>'Presentase','name'=>'percentage','type'=>'number','validation'=>'integer|min:0','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Date Report','name'=>'date_report','type'=>'datetime','validation'=>'required|date_format:d-m-Y H:i:s','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Pre Image','name'=>'pre_image','type'=>'upload','validation'=>'required|image|max:2048','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Post Image','name'=>'post_image','type'=>'upload','validation'=>'required|image|max:2048','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Presentase','name'=>'percentage','type'=>'number','validation'=>'integer|min:0','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Status Report','name'=>'status_report','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'proses;selesai'];
